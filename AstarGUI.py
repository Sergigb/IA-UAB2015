...
class _Astargui:
    ...
    def __init__(self, master):
        ...
        print str(2000./1300)
        print math.ceil(770/900)*RHeight
        ...
        self.Label_3.place(x=300./1300*RWidth, y=280./900*RHeight)
        ...
        self.LabelFilenameMetro.place(x=70./1300*RWidth, y=80./900*RHeight)
        self.Text_filenameMetro = Entry(self.master, textvariable=self.filenameMetro)
        self.Text_filenameMetro.place(x=70./1300*RWidth, y=110./900*RHeight, width=170, height=20)
        self.LabelFilenameCorrespondences = Label(self.master, text="Fitxer de Correspondencies :", justify=LEFT)
        self.LabelFilenameCorrespondences.place(x=70./1300*RWidth, y=140./900*RHeight)
        self.Text_filenameConnections = Entry(self.master, textvariable=self.filenameConnections)
        self.Text_filenameConnections.place(x=70./1300*RWidth, y=170./900*RHeight, width=170, height=20)
        self.LabelFilenametimeTransfers = Label(self.master, text="Fitxer de Temps de Transbords :", justify=LEFT)
        self.LabelFilenametimeTransfers.place(x=70./1300*RWidth, y=200./900*RHeight)
        self.Text_filenametimeTransfers = Entry(self.master, textvariable=self.filenametimeTransfers)
        self.Text_filenametimeTransfers.place(x=70./1300*RWidth, y=230./900*RHeight, width=170, height=20)
        self.LabelFilenameTimeStations = Label(self.master, text="Fitxer de Temps Entre Estacions :", justify=LEFT)
        self.LabelFilenameTimeStations.place(x=70./1300*RWidth, y=260./900*RHeight)
        self.Text_filenameStations = Entry(self.master, textvariable=self.filenameTimeStations)
        self.Text_filenameStations.place(x=70./1300*RWidth, y=290./900*RHeight, width=170, height=20)

        # OUTPUTS TITLES
        self.Label_5 = Label(self.master, text="Temps Total: ", image="", width="15", justify=LEFT, anchor=W)
        self.Label_5.place(x=80./1300*RWidth, y=450./900*RHeight, width=113, height=23)
        self.Label_6 = Label(self.master, text="Distancia :", image="", width="15", justify=LEFT, anchor=W)
        self.Label_6.place(x=80./1300*RWidth, y=500./900*RHeight, width=113, height=23)
        self.Label_7 = Label(self.master, text="Transbords : ", width="15", justify=LEFT, anchor=W)
        self.Label_7.place(x=80./1300*RWidth, y=550./900*RHeight, width=113, height=23)
        self.Label_8 = Label(self.master, text="Parades : ", image="", width="15", justify=LEFT, anchor=W)
        self.Label_8.place(x=80./1300*RWidth, y=600./900*RHeight, width=113, height=23)
        self.Label_9 = Label(self.master, text="Nodes Expandits : ", image="", width="15", justify=LEFT, anchor=W)
        self.Label_9.place(x=80./1300*RWidth, y=650./900*RHeight, width=113, height=23)
        ...
        self.Check_Button_Distance_Radiobutton = Radiobutton(self.master, text="Minima Distancia",
                                                             variable=self.typePreference, value=0, justify=LEFT)
        ...
        self.Check_Button_StopStations_Radiobutton = Radiobutton(self.master, text="Minim Parades",
        ...
        self.Check_Button_Time_Radiobutton = Radiobutton(self.master, text="Minim Temps", variable=self.typePreference,
        ...
        self.Check_Button_Connections_Radiobutton = Radiobutton(self.master, text="Minim Transbords",
                                                                variable=self.typePreference, value=3, justify=LEFT)
            ...
            if self.id_desti != -1:  # If a destination is selected, continue
                if self.typePreference != -1:  # If a preference is selected, run ASTAR algorithm and show the Optimal Path
                    time, distance, transfers, stopStations, expanded_nodes, num_depth, visited_nodes, idoptimalpath, min_distance_origin, min_distance_destination = AstarAlgorithm(
                        self.stationList, self.connections, self.coord_origin, self.coord_destination,
                        self.typePreference, self.timeTransfers, self.timeStations)
